...
public class OdooObjectDelete extends BaseStep implements StepInterface {
  private OdooObjectDeleteMeta meta;
  private OdooObjectDeleteData data;

  private int idIndex;

  public OdooObjectDelete( StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr, TransMeta transMeta,
                              Trans trans ) {
  ...
  public boolean processRow( final StepMetaInterface smi, final StepDataInterface sdi ) throws KettleException {
    ...
    try {
      ...
      // Odoo XMLRPC interface doesn't support extended attributes (that includes long values).
  ...
  public boolean init( StepMetaInterface smi, StepDataInterface sdi ) {
    meta = (OdooObjectDeleteMeta) smi;
    data = (OdooObjectDeleteData) sdi;
