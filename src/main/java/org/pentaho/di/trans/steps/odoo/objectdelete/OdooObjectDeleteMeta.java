...
@Step( id = "OdooObjectDelete", image = "org/pentaho/di/trans/steps/odoo/objectdelete/resources/OdooObjectDelete.svg",
  i18nPackageName = "org.pentaho.di.trans.steps.odoo.objectdelete", name = "OdooObjectDelete.TransName",
  description = "OdooObjectDelete.TransDescription", documentationUrl = "http://wiki.pentaho.com/display/EAI/OpenERP+Object+Delete",
  categoryDescription = "i18n:org.pentaho.di.trans.step:BaseStep.Category.Output" )
public class OdooObjectDeleteMeta extends BaseStepMeta implements StepMetaInterface {
  ...
  public StepInterface getStep( StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr,
    ...
    return new OdooObjectDelete( stepMeta, stepDataInterface, copyNr, transMeta, trans );
  }

  @Override
  public StepDataInterface getStepData() {
    try {
      return new OdooObjectDeleteData( this.databaseMeta );
    } catch ( Exception e ) {
      return null;
    }
  }
