...
@Step( id = "OdooObjectOutputImport", image = "org/pentaho/di/trans/steps/odoo/objectoutput/resources/OdooObjectOutput.svg",
  i18nPackageName = "org.pentaho.di.trans.steps.odoo.objectoutput", name = "OdooObjectOutput.TransName",
  description = "OdooObjectOutput.TransDescription", documentationUrl = "http://wiki.pentaho.com/display/EAI/OpenERP+Object+Output",
  categoryDescription = "i18n:org.pentaho.di.trans.step:BaseStep.Category.Output" )
public class OdooObjectOutputMeta extends BaseStepMeta implements StepMetaInterface {
  ...
  public StepInterface getStep( StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr,
    ...
    return new OdooObjectOutput( stepMeta, stepDataInterface, copyNr, transMeta, trans );
  }

  @Override
  public StepDataInterface getStepData() {
    try {
      return new OdooObjectOutputData( this.databaseMeta );
    } catch ( Exception e ) {
      return null;
    }
  }
