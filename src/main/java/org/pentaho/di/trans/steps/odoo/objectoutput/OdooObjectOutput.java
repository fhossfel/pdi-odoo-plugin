...
public class OdooObjectOutput extends BaseStep implements StepInterface {
  ...
  private OdooObjectOutputData data;
  ...
  public OdooObjectOutput( StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr, TransMeta transMeta,
                              Trans trans ) {
  ...
  private void prepareCache() throws XmlRpcException, OdooApiException {
  ...
  public boolean init( StepMetaInterface smi, StepDataInterface sdi ) {
    meta = (OdooObjectOutputMeta) smi;
    data = (OdooObjectOutputData) sdi;
