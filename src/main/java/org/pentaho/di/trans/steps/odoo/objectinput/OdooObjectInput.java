...
public class OdooObjectInput extends BaseStep implements StepInterface {
  private OdooObjectInputMeta meta;
  private OdooObjectInputData data;

  public OdooObjectInput( StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr, TransMeta transMeta,
                             Trans trans ) {
  ...
  public boolean init( StepMetaInterface smi, StepDataInterface sdi ) {
    meta = (OdooObjectInputMeta) smi;
    data = (OdooObjectInputData) sdi;

    if ( super.init( smi, sdi ) ) {
      try {
        this.logDebug( "Initializing Odoo Session" );
        data.helper = new OdooHelper( meta.getDatabaseMeta() );
