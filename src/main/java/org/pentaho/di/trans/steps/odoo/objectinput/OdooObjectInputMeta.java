...
package org.pentaho.di.trans.steps.odoo.objectinput;
...
@Step( id = "OdooObjectInput", image = "org/pentaho/di/trans/steps/odoo/objectinput/resources/OdooObjectInput.svg",
  i18nPackageName = "org.pentaho.di.trans.steps.odoo.objectinput", name = "OdooObjectInput.TransName",
  description = "OdooObjectInput.TransDescription", documentationUrl = "http://wiki.pentaho.com/display/EAI/OpenERP+Object+Input",
  categoryDescription = "i18n:org.pentaho.di.trans.step:BaseStep.Category.Input" )
public class OdooObjectInputMeta extends BaseStepMeta implements StepMetaInterface {
  ...
  public void getFields( final RowMetaInterface row, final String origin, final RowMetaInterface[] info,
    ...
    if ( databaseMeta == null ) {
      throw new KettleStepException( "There is no Odoo database server connection defined" );
    }

    final OdooHelper helper = new OdooHelper( databaseMeta );
    try {
      helper.StartSession();
  ...
  public StepInterface getStep( StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr,
    ...
    return new OdooObjectInput( stepMeta, stepDataInterface, copyNr, transMeta, trans );
  }

  @Override
  public StepDataInterface getStepData() {
    try {
      return new OdooObjectInputData( this.databaseMeta );
    } catch ( Exception e ) {
      return null;
    }
  }
