...
public class OdooObjectInputData extends BaseStepData implements StepDataInterface {

  public OdooHelper helper;

  public OdooObjectInputData( DatabaseMeta databaseMeta ) throws KettleException {
    super();
